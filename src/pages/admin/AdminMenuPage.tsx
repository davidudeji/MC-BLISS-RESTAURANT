...
const MOCK_ITEMS: MenuItem[] = [
  ...
  { id: '2', name: 'Green Goddess Salad', slug: 'green-goddess', description: 'Seasonal greens, cucumber, edamame.', price: 6000, category: 'NUTRITIOUS_MEALS', status: 'AVAILABLE', imageUrl: 'https://images.unsplash.com/photo-1547592180-85f173990554?auto=format&fit=crop&w=900&q=85', imagePublicId: null, batchQuantity: 8, isFeatured: false, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  ...
  { id: '5', name: 'Ginger Citrus Zobo', slug: 'ginger-zobo', description: 'Zingy hibiscus with lime and orange.', price: 2500, category: 'ZOBO_JUICES', status: 'OUT_OF_STOCK', imageUrl: 'https://images.unsplash.com/photo-1610970881699-44a5587cabec?auto=format&fit=crop&w=900&q=85', imagePublicId: null, batchQuantity: 0, isFeatured: false, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
];
