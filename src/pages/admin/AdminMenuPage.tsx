...
const MOCK_ITEMS: MenuItem[] = [
  { id: '1', name: 'Organic Avocado & Egg Bowl', slug: 'avocado-egg', description: 'Creamy avocado, farm eggs, greens.', price: 7500, category: 'NUTRITIOUS_MEALS', status: 'AVAILABLE', imageUrl: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=900&q=85', imagePublicId: null, batchQuantity: 18, isFeatured: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: '2', name: 'Green Goddess Salad', slug: 'green-goddess', description: 'Seasonal greens, cucumber, edamame.', price: 6000, category: 'NUTRITIOUS_MEALS', status: 'AVAILABLE', imageUrl: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=900&q=85', imagePublicId: null, batchQuantity: 8, isFeatured: false, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: '3', name: 'Tropical Yogurt Bowl', slug: 'tropical-yogurt', description: 'Probiotic yogurt with tropical fruits.', price: 5500, category: 'YOGURT_BOWLS', status: 'AVAILABLE', imageUrl: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?auto=format&fit=crop&w=900&q=85', imagePublicId: null, batchQuantity: 12, isFeatured: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: '4', name: 'Cold-Steeped Hibiscus Zobo', slug: 'hibiscus-zobo', description: 'Cold-steeped hibiscus with ginger.', price: 2500, category: 'ZOBO_JUICES', status: 'AVAILABLE', imageUrl: 'https://images.unsplash.com/photo-1544145945-f90425340c7e?auto=format&fit=crop&w=900&q=85', imagePublicId: null, batchQuantity: 5, isFeatured: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: '5', name: 'Ginger Citrus Zobo', slug: 'ginger-zobo', description: 'Zingy hibiscus with lime and orange.', price: 2500, category: 'ZOBO_JUICES', status: 'OUT_OF_STOCK', imageUrl: 'https://images.unsplash.com/photo-1544145945-f90425340c7e?auto=format&fit=crop&w=900&q=85', imagePublicId: null, batchQuantity: 0, isFeatured: false, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
];
